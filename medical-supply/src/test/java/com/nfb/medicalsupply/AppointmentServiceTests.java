...
public class AppointmentServiceTests {
    ...
    //ZAKOMENTARISAN TEST TAKODjE PROLAZI
    //On pokazuje da Administrator moze realizovati dvije porudzbine u nekratkom vremenskom rastojanju
    //Zakomentarisan je da ne bismo pisali jos testnih podataka :)
    //Zbog toga, u jednom trenutku pokrecemo samo jedan test
    /*
    @Test
    public void testCAisPresentAtTwoAppointmentsAtDifferentTime() throws Throwable {

        ExecutorService executor = Executors.newFixedThreadPool(2);
        Future<Long> future1 = executor.submit(() -> {
            System.out.println("Startovan Thread 1");
            try { Thread.sleep(25000); } catch (InterruptedException e) {} // thread uspavan na 3 sekunde da bi drugi thread mogao da izvrsi istu operaciju
