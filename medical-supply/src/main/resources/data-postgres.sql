...
VALUES (1, false, 111, 0, 4, 1, '2023-02-01T14:00:00', NULL, 3);

-- Prvi entitet
INSERT INTO public.appointments(duration, is_downloaded, reservation_number, type, company_administrator_id, id, pick_up_date, registred_user_id, working_day_id)
VALUES (1, false, 151, 0, 4, 2, '2023-02-04T15:00:00', NULL, 4);

-- Drugi entitet
INSERT INTO public.appointments(duration, is_downloaded, reservation_number, type, company_administrator_id, id, pick_up_date, registred_user_id, working_day_id)
VALUES (2, true, 222, 1, 4, 3, '2023-02-07T15:10:00', NULL, 5);
...
-- Četvrti entitet
INSERT INTO public.appointments(duration, is_downloaded, reservation_number, type, company_administrator_id, id, pick_up_date, registred_user_id, working_day_id)
VALUES (4, true, 444, 1, 4, 5, '2023-04-10T17:00:00', 1, 7);

-- Peti entitet
INSERT INTO public.appointments(duration, is_downloaded, reservation_number, type, company_administrator_id, id, pick_up_date, registred_user_id, working_day_id)
VALUES (1, false, 555, 0, 4, 6, '2023-06-17T18:00:00', 1, 8);
...
-- Sedmi entitet
INSERT INTO public.appointments(duration, is_downloaded, reservation_number, type, company_administrator_id, id, pick_up_date, registred_user_id, working_day_id)
VALUES (3, false, 777, 0, 4, 8, '2023-09-09T10:00:00', 1, 10);

-- Osmi entitet
INSERT INTO public.appointments(duration, is_downloaded, reservation_number, type, company_administrator_id, id, pick_up_date, registred_user_id, working_day_id)
VALUES (4, true, 888, 1, 4, 9, '2023-10-07T11:30:00', 1, 11);
